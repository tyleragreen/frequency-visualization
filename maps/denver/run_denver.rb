...
#----------------------------------------------------
#
# A script that reads the Transitland API and compiles a 
...
#----------------------------------------------------
OUTPUT_DIR        = "output"
START_TIME        = Time.new(2016,05,13,7,30,00)
END_TIME          = Time.new(2016,05,14,8,00,00)
SECONDS_PER_HOUR  = 3600
# FIXME change this to detect light rail vs buses
SUBWAY_ONESTOP_ID = "f-dr5r-nyctsubway"
COORDINATES   = [ -105.29, 39.53,
                  -104.63, 39.99 ]
LINE_WIDTH        = 2.5
...
pairs = TransitlandClient::ScheduleStopPair.find_by(bbox: COORDINATES.join(','),
                                                    date: date,
...
stops = TransitlandClient::Stop.find_by(bbox: COORDINATES.join(','))
